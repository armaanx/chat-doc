...
const PdfRenderer = ({ url }: PdfRendererProps) => {
    ...
    return <div className="w-full bg-white rounded-md flex flex-col shadow items-center">
                ...
                <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                        <Button className="gap-1.5" aria-label="zoom" variant={"ghost"}>
                            ...
                            {scale * 100}% <ChevronDown className="h-3 opacity-80 w-3"/>
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent>
                        ...
                        {isLoading && renderedScale ?
                            ...
                            <Page
                                ...
                                loading={<div className="flex justify-center">
                                    <Loader2 className="animate-spin h-4 w-4 my-24"/>
                                </div>} />}
                </Document>
            </div>
            </SimpleBar>
